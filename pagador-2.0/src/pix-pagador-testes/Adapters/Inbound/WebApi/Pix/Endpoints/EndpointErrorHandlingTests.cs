...
//        var exception = new ArgumentException("Erro na factory");
//        _mockTransactionFactory
//            .Setup(x => x.CreateRegistrarOrdemPagamento(It.IsAny<HttpContext>(), It.IsAny<JDPIRegistrarOrdemPagtoRequest>(), It.IsAny<string>()))
//            .Throws(exception);

//        // Act & Assert
//        Assert.Throws<ArgumentException>(() =>
//        {
//            _mockTransactionFactory.Object.CreateRegistrarOrdemPagamento(
//                new Mock<HttpContext>().Object,
//                new JDPIRegistrarOrdemPagtoRequest(),
//                "correlation-id");
//        });
//    }

//    [Fact]
//    public void Endpoints_ComCorrelationIdException_DevemTratarErro()
//    {
//        // Arrange
//        var exception = new Exception("Erro na geração do correlation ID");
//        _mockCorrelationIdGenerator
//            .Setup(x => x.GenerateWithPrefix(It.IsAny<string>(),12))
//            .Throws(exception);

//        // Act & Assert
//        Assert.Throws<Exception>(() =>
//        {
//            _mockCorrelationIdGenerator.Object.GenerateWithPrefix("TEST",12);
//        });
//    }
//}
